...
name: psdd
description: >
  PSDD (Process-augmented Spec Driven Development) 방법론.
  신규 기능 문서화, 멀티에이전트 역할 분담, docs/ 구조 작성 시 사용.
---

# PSDD — Process-augmented Spec Driven Development

Kiro SDD 확장판. 비즈니스 프로세스 레이어(biz-process.md)와 UI 명세 레이어(uis.md)를 추가.
**도구 독립적**: Kiro, Gemini, Claude, Antigravity 모두 이 규칙을 따른다.
